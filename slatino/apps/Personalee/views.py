...
def personalee_list(request):
    ...
    return render_to_response("Personalee/list.html", RequestContext(request, {"all_personalee": all_personalee, "page": page}))


def personalee_show(request, personalee_id):
    personalee = get_object_or_404(Personalee, id=personalee_id)
    return render_to_response("Personalee/one.html", RequestContext(request, {"personalee": personalee}))
